...
module.exports = class extends Command {
    ...
    async run(message) {
        if (message.channel.id !== '759168313342296154' && message.channel.id !== '770439146169958400' && message.channel.id !== '729781200159506512' && message.channel.id !== '777132691316932619' && message.channel.id !== '784013671843102720') return;
        else {
            if (data.lang === "RU") {
            message.delete()
            const embed = new MessageEmbed()
                ...
                .setColor('34B7EB')
                .addField("**Информация & Новичок**", ":mouse_three_button: Для получения некоторых полезных ссылок, напишите в <#784013671843102720> команду \"!help\" (без \"\").\nКоманды, разрешенные в чатах общения: w/l, !report, !suggest (подробнее о данных командах здесь: https://clck.ru/SGJ9d).\nДля нахождения описания ролей, плюшек бустеров сервера, чатах и ролей по упоминания, перейдите в <#784013671843102720> и прочитайте всё.")
