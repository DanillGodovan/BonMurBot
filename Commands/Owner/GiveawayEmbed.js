...
module.exports = class extends Command {
	...
	async run(message) {
        ...
        .setColor('34B7EB')
        .setDescription(`Конкурсы & Плюшки / Giveaways & Buns`)
        .addField("**Конкурсы & Плюшки**", "Сюда публикуются конкурсы на разные вещи с условиями или без.\nУдачи в победах.")
        .addField("**Giveaways & Buns**", "Giveaways for various things with or without conditions are published here.\nGood luck with Your victories.")
