...
module.exports = class extends Command {
	...
	async run(message) {
        ...
        .setColor('34B7EB')
        .setDescription(`Complaints & Violations`)
        .addField("**Complaints & Violations**", "To submit a complaint to this chat, write \"!report <@user> <complaint> <image of evidence>\" in the chat rooms for communication or commands.\nPlease do not simply file complaints, otherwise you risk getting punished.")
