...
module.exports = class extends Command {
	...
	async run(message) {
        ...
        .setColor('34B7EB')
        .setDescription(`Жалобы & Нарушения`)
        .addField("**Жалобы & Нарушения**", "Для подачи жалобы в этот чат, напишите \"!report <@пользователь> <жалоба> <изображение доказательств>\" в чатах по общению или команд.\nПросьба не подавать попросту жалобы, иначе рискуете получить наказание.")
