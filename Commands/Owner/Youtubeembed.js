...
module.exports = class extends Command {
	...
	async run(message) {
        ...
        .addField("**Интересное & Основное**", "Видео / Стримы ютубера BRO ИГРАЮТ публикуются сюда.\nНе забудьте подписаться!\nЕсли вы хотите получать уведомления о новых видео, перейдите в чат <#770823966612258879>, найдите последнее сообщение и нажмите на вторую реакцию.")
        .addField("**Interesting & General**", "Videos / Streams of youtuber BRO ИГРАЮТ are published here.\nDon't forget to subscribe!\nIf you want to receive notifications about new videos, go to the chat <#770823966612258879>, find the last message and click on the second reaction.")
