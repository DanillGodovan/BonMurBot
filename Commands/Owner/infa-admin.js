...
module.exports = class extends Command {
  ...
  async run(message) {
    if (message.channel.id !== "729674213522407485") {
      ...
      if (usedCommand.has(message.author.id)) {
        ...
        message.channel.send("**Russian / Русский**", { embed: sEmbed })
          .then((msg) => msg.delete({ timeout: 900000 }));
        let mEmbed = new MessageEmbed()
          .setColor("2F3136")
          .setTitle("Information for administrators")
        ...
        message.channel.send("**English / Английский**", { embed: mEmbed })
          .then((msg) => msg.delete({ timeout: 900000 }));
        message.delete();
